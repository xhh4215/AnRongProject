package com.example.xiaohei.ui.view;
...
import com.example.xiaohei.context.CommonDef;
import com.example.xiaohei.contral.BitmapCtl;
import com.example.xiaohei.contral.EraserCtl;
import com.example.xiaohei.contral.ISketchpadDraw;
import com.example.xiaohei.contral.IUndoRedoCommand;
import com.example.xiaohei.contral.RectuCtl;
...
public class SketchpadView extends View implements IUndoRedoCommand {
    ...
    public static void setStrokeSize(int size) {   //设置画笔的大小
                m_penSize = size;
    }
//    public static void setStrokeSize2(int size, int type) {   //设置画笔的大小和橡皮擦大小
//        switch (type) {
//            case STROKE_PEN:
//                m_penSize = size;
//                break;
...
//    }
    ...
    public static int getStrokeColor() {   //得到画笔的颜色
    ...
    public void setCanvasSize(int width, int height) {//设置画布大小
        if (width > 0 && height > 0) {
