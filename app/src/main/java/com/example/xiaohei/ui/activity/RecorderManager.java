...
import com.daniulive.smartpublisher.RecorderPlayback;
...
public class RecorderManager extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.daniulive.smartpublisher.R.layout.activity_recorder_manager);

        Intent intent = getIntent();
        recDirPath = intent.getStringExtra("RecoderDir");

        btnDelAllRecFiles = (Button)findViewById(com.daniulive.smartpublisher.R.id.button_delete_all_rec_files);
        btnDelAllRecFiles.setOnClickListener(new ButtonDelAllRecFilesListenser());

        recFileListView = (ListView) findViewById(com.daniulive.smartpublisher.R.id.rec_file_list);
        GetRecFileList();

        SimpleAdapter ladapter = new SimpleAdapter(this,getMapData(fileList), com.daniulive.smartpublisher.R.layout.rec_files_list_view_item,
        		new String[]{"ItemFileName"},new int[]{com.daniulive.smartpublisher.R.id.ItemFileName});
