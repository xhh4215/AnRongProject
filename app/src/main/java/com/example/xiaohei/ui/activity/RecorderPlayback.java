...
public class RecorderPlayback extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(com.daniulive.smartpublisher.R.layout.activity_recorder_playback);
        
        Intent intent = getIntent();
        recorderFilePath = intent.getStringExtra("RecorderFilePath");
        
        
        filePathTextView = (TextView) findViewById(com.daniulive.smartpublisher.R.id.textViewRecoderPlaybackFilePath);
        ...
        playVideoView  = (VideoView) findViewById(com.daniulive.smartpublisher.R.id.VideoViewRecoderPlayback);
